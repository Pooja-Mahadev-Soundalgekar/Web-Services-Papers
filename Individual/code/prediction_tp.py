...
with open("USF_predicted_tp_userp.txt") as f1:
    text1 = f1.read()
...
for val in values2:
	...
	news = news[:-1]
	webs.append(news)
with open("ktpusers_USF.csv") as f3:
    text3 = f3.read()
...
for val in values:
	...
	news = news[:-1]
	N1.append(news)
with open("ktpservices_USF.csv") as f4:
    text4 = f4.read()
...
for val in values:
	...
	news = news[:-1]
	N2.append(news)
with open("tpsimusers_USF.txt") as f5:
    text5 = f5.read()
...
with open("tpsimweb_USF.txt") as f6:
    text6 = f6.read()
...
for c in range(len(final)):
	...
	for s in final[c]: 
		print i,c
		print final[c][i]
		with open("USF_predicted_tp_userp_mae.txt","a") as f5:
			f5.write("%f " % (userp[c][i]))
		with open("USF_predicted_tp_itemp_mae.txt","a") as f6:
