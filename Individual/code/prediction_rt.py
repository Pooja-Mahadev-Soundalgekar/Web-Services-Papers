...
with open("USF_predicted_rt_userp.txt") as f1:
    text1 = f1.read()
...
for val in values2:
	...
	news = news[:-1]
	webs.append(news)
with open("krtusers_USF.csv") as f3:
    text3 = f3.read()
...
for val in values:
	...
	news = news[:-1]
	N1.append(news)
with open("krtservices_USF.csv") as f4:
    text4 = f4.read()
...
for val in values:
	...
	news = news[:-1]
	N2.append(news)
with open("rtsimusers_USF.txt") as f5:
    text5 = f5.read()
...
with open("rtsimweb_USF.txt") as f6:
    text6 = f6.read()
...
for c in range(len(final)):
	...
	for s in final[c]: 
		print i,c
		print final[c][i]
		with open("USF_predicted_rt_userp_mae.txt","a") as f5:
			f5.write("%f " % (userp[c][i]))
		with open("USF_predicted_rt_itemp_mae.txt","a") as f6:
		...
		with open("USF_predicted_tp_all_u.txt","a") as f4:
			f4.write("%f " % (predicted1[c][i]))
		with open("USF_predicted_tp_all_i.txt","a") as f7:
			f7.write("%f " % (predicted2[c][i]))
		i=i+1
	with open("USF_predicted_rt_all_u.txt","a") as f4:
		f4.write("\n")
	with open("USF_predicted_rt_all_i.txt","a") as f7:
		f7.write("\n")
	with open("USF_predicted_rt_userp_mae.txt","a") as f5:
		f5.write("\n")
	with open("USF_predicted_rt_itemp_mae.txt","a") as f6:
